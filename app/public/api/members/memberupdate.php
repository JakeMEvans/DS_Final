...
$stmt = $db->prepare(
  'UPDATE Person  SET firstName = ?, lastName = ?, Gender = ?, DOB = ?, Address = ?, Email = ?, Phone = ?, Position = ?, startDate = ?, radioNum = ?, stationNum = ?, isActive = ?
  WHERE PersonID = ?'
);
...
header('Location: ../members/memberindex.php');
